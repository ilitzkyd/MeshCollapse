...
if __name__ == "__main__":
    # comment: there is a inconsistency among the coordinate conventions
    # of the code with skimage
    # for 3d gray scale image, the order convention in skimage is (pln, row, col)
